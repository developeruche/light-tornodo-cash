...
library HasherProvider {
    function MiMC5Feistel(uint256 _iL, uint256 _iR, uint256 _k, uint256 p, uint256[20] memory c) internal pure returns(uint256 oL, uint256 oR) {
        uint8 nRounds = 20;
    ...
    function MiMC5Sponge(uint256[2] memory _ins, uint256 _k, uint256 p, uint256[20] memory c) internal pure returns(uint256 h) {
        uint256 lastR = 0;
        uint256 lastC = 0;
